  ...
  <div class="mt-16">
    <form @submit.prevent="handleSubmit">
      ...
      <button
        ...
        class="px-8 py-3 mt-10 text-2xl font-bold text-white rounded-full bg-brand-main focus:outline-none duration-150"
      >
        <icon
          v-if="state.isLoading"
          name="loading"
          class="animate_animated animate-spin"
        />
